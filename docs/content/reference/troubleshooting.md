...
Most of these come down to network reality or how sinafinance-cli serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

sinafinance-cli rate-limits like any public site. sinafinance already paces
...
Where a surface is gated, sinafinance reads a cookie or token you supply
...
`sinafinance`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what sinafinance actually did
